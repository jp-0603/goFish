...
public class GoFish {
    ...
    private static boolean[] request = {false, false, false, false, false, false, false, false, false, false, false, false, false};
    ...
    public void askType() {
        ...
        } while (selection.equals("P") == false && selection.equals("C")== false);
    ...
    public void multiPlayer() {
        ...
        while (true) {
            ...
            String winMessage1 = "Congratulations PLAYER 1, you won " + player1Books + " books to " + player2Books + ".";
            String winMessage2 = "Congratulations PLAYER 2, you won " + player2Books + " books to " + player1Books + ".";
            ...
            if (player1Books + player2Books == 13) {
                ...
                if (player1Books > player2Books) {
                    System.out.println(winMessage1);
                } else if (player2Books > player1Books) {
                    System.out.println(winMessage2);
                } else {
    ...
    public void updateCurrentTurnRequests(Card rank){
        request[Card.getOrderedRank(rank.getRank()) - 2] = false;
    }
